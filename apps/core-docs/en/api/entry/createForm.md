...
| validatePattern | Field interaction patterns that allow validation | `FormPatternTypes[]`                                          | `['editable']` |
| validateDisplay | Field display states that allow validation       | `FormDisplayTypes[]`                                          | `['visible']`  |
