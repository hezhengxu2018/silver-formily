...
export const permissionSource: PermissionRecord[] = [
  { key: 'user:read', label: 'View Users', module: 'user' },
  { key: 'user:edit', label: 'Edit Users', module: 'user' },
  { key: 'order:read', label: 'View Orders', module: 'order' },
  { key: 'order:refund', label: 'Order Refunds', module: 'order' },
  { key: 'finance:read', label: 'View Bills', module: 'finance' },
  { key: 'finance:export', label: 'Export Bills', module: 'finance' },
]
