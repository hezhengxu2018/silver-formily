...
<template>
  <FormProvider :form="form">
    <FormLayout :label-col="4" :wrapper-col="16">
      <ElText>all, including half-checked nodes, initial value: [1, 4, 9, 2, 5]</ElText>
      <Field
        name="tree1"
        title="Tree1"
        :decorator="[FormItem]"
      ...
      />
      <ElText>all, excluding half-checked nodes, initial value: [9, 5]</ElText>
      <Field
        name="tree2"
        title="Tree2"
        :decorator="[FormItem]"
        ...
        :initial-value="[9, 5]"
      />
      <ElText>parent, initial value: [1]</ElText>
      <Field
        name="tree3"
        title="Tree3"
        :decorator="[FormItem]"
        ...
        :initial-value="[1]"
      />
      <ElText>child, initial value: [8, 9]</ElText>
      <Field
        name="tree4"
        title="Tree4"
        :decorator="[FormItem]"
        ...
        :initial-value="[8, 9]"
      />
      <ElText>path, initial value: full selected path</ElText>
      <details>
