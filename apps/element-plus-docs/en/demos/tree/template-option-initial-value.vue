...
<template>
  <FormProvider :form="form">
    <FormLayout :label-col="4" :wrapper-col="16">
      <ElText>all, including half-checked nodes, initial value: </ElText>
      <details>
      ...
      />
      <ElText>all, excluding half-checked nodes, initial value: </ElText>
      <details>
        <summary>Expand</summary>
      ...
      />
      <ElText>parent, initial value: </ElText>
      <details>
        <summary>Expand</summary>
      ...
      />
      <ElText>child, initial value: </ElText>
      <details>
        <summary>Expand</summary>
