...
<template>
  <div class="playground">
    <p class="hint">
      This demo combines several <code>define</code> annotations:
      <code>deep</code>, <code>shallow</code>, <code>ref</code>, <code>box</code>, and
      <code>computed</code>.
    </p>

    <div class="inputRow">
      <div class="inputGroup">
        <label for="define-next-deep-en">deep value for action</label>
        <input
          id="define-next-deep-en"
          class="input"
          type="number"
          :value="nextDeep"
      ...
      <div class="inputGroup">
        <label for="define-next-box-en">box value for action</label>
        <input
          id="define-next-box-en"
          class="input"
          type="number"
          :value="nextBox"
      ...
      <div class="inputGroup">
        <label for="define-next-ref-en">ref value</label>
        <input
          id="define-next-ref-en"
          class="input"
          type="text"
          :value="nextRef"
