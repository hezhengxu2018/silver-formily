...
import { autorun, observable, raw } from '@silver-formily/reactive'
...
<template>
  <div class="playground">
    <p class="hint">
      <code>raw</code> returns the source reference for the current observable object. It is not a
      deep clone, so you can still reach the raw nested object, but the returned value itself is no
      longer an observable proxy.
    </p>
