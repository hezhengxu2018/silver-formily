...
| [`@silver-formily/reactive`](https://reactive.silver-formily.org/) | 提供响应式状态能力，是 observable、reaction 和依赖追踪的基础。 |
...
| 模块                                                                     | 职责                                                                 |
| ------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [`@silver-formily/core`](https://core.silver-formily.org/)               | 表单运行时核心，负责表单状态、字段生命周期、effects 编排和校验调度。 |
| [`@silver-formily/json-schema`](https://json-schema.silver-formily.org/) | 提供 Schema 描述层，把 JSON Schema 风格结构映射到表单运行时语义。    |
| [`@silver-formily/validator`](https://validator.silver-formily.org/)     | 提供声明式校验能力，支持规则、格式、本地化和异步校验。               |
| [`@silver-formily/path`](https://path.silver-formily.org/)               | 提供路径解析、模式匹配和深层访问工具，供运行时模块复用。             |
...
| 模块                                                                       | 职责                                                              |
| -------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [`@silver-formily/vue`](https://vue.silver-formily.org/)                   | Vue 3 渲染层，负责字段组件、Schema 渲染和 Vue 侧适配能力。        |
| [`@silver-formily/reactive-vue`](https://reactive-vue.silver-formily.org/) | 将响应式内核接入 Vue 3，负责 observer、生命周期联动和副作用绑定。 |
...
| 模块                                                                       | 职责                                                               |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| [`@silver-formily/element-plus`](https://element-plus.silver-formily.org/) | 提供基于 Element Plus 的桌面端表单组件绑定和场景化封装。           |
| [`@silver-formily/vant`](https://vant.silver-formily.org/)                 | 提供基于 Vant 的移动端表单组件绑定和场景化封装。                   |
| [`@silver-formily/grid`](https://grid.silver-formily.org/)                 | 提供响应式栅格布局能力，根据容器尺寸、断点和字段跨度组织表单布局。 |
