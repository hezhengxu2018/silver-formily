...
| Script                        | Description                                                                                                    |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `pnpm dev -- vue-docs`        | Starts the docs site through Turbo, which builds dependency artifacts first.                                   |
| `pnpm docs:build`             | Runs VitePress; the root Turbo task builds dependencies first and emits `.vitepress/dist`.                     |
