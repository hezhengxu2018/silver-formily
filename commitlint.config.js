...
export default {
  ...
  prompt: {
    ...
    themeColorCode: '',
    scopes: [
      { value: 'apps/silver-formily-docs', name: 'apps/silver-formily-docs' },
      ...
      { value: 'apps/element-plus-designable', name: 'apps/element-plus-designable' },
      { value: 'packages/core', name: 'packages/core' },
      { value: 'packages/designer-core', name: 'packages/designer-core' },
      { value: 'packages/designer-shared', name: 'packages/designer-shared' },
      { value: 'packages/designer-vue', name: 'packages/designer-vue' },
      ...
      { value: 'packages/path', name: 'packages/path' },
      { value: 'packages/reactive', name: 'packages/reactive' },
      { value: 'packages/reactive-vue', name: 'packages/reactive-vue' },
      { value: 'packages/shared', name: 'packages/shared' },
      { value: 'packages/typescript-config', name: 'packages/typescript-config' },
      { value: 'packages/validator', name: 'packages/validator' },
