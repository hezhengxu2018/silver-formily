...
it('setLoading/setValidating', async () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'aa',
...
it('setComponent/setComponentProps', () => {
...
it('selfValidate/errors/warnings/successes/valid/invalid/validateStatus/queryFeedbacks', async () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'aa',
...
it('objectFieldWithInitialValue', async () => {
  const form = attach(
    createForm({
      initialValues: {
        obj: {
...
it('resetObjectFieldWithInitialValue', async () => {
  const form = attach(createForm())
  attach(
    form.createObjectField({
      name: 'obj',
...
it('setData/setContent in void field', () => {
  const form = attach(createForm())
...
it('setErrors/setWarnings/setSuccesses/setValidator', async () => {
  const form = attach(createForm())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('array path calculation with none index', async () => {
  const form = attach(createForm())
  const array = attach(
    form.createArrayField({
      name: 'array',
...
it('array path calculation with none index and void nested', async () => {
  const form = attach(createForm())
  const array = attach(
    form.createArrayField({
      name: 'array',
...
it('array path calculation with object index', async () => {
  const form = attach(createForm())
  const array = attach(
    form.createArrayField({
      name: 'array',
...
it('array path calculation with void index', async () => {
  const form = attach(createForm())
  const array = attach(
    form.createArrayField({
      name: 'array',
...
it('array path calculation with void index and void wrapper', async () => {
  const form = attach(createForm())
  attach(
    form.createVoidField({
      name: 'layout',
...
it('nested fields hidden and selfValidate', async () => {
  const form = attach(createForm())
  const parent = attach(
    form.createVoidField({
      name: 'parent',
...
it('deep nested fields hidden and selfValidate', async () => {
  const form = attach(createForm())
...
it('deep nested fields hidden and selfValidate with middle hidden', async () => {
  const form = attach(createForm())
  const parent1 = attach(
    form.createVoidField({
      name: 'parent1',
...
it('fields unmount and selfValidate', async () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'parent',
...
it('auto clean with ObjectField', () => {
  const form = attach(createForm())
  attach(
    form.createObjectField({
      name: 'obj',
...
it('field submit with error', async () => {
  const form = attach(createForm())
  const childForm = attach(
    form.createObjectField({
      name: 'aa',
...
it('state depend field visible value', async () => {
  const form = attach(createForm())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('reactions initialValue and value', () => {
  const form = attach(
    createForm({
      values: {
        aa: {
...
it('field name is length in initialize', () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'length',
...
it('field name is length in dynamic assign', () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'length',
...
it('nested field modified', async () => {
  const form = attach(createForm())
  const obj = attach(
    form.createObjectField({
      name: 'object',
...
it('field setValidator repeat call', async () => {
  const form = attach(createForm())
  const field = attach(
    form.createField({
      name: 'normal',
...
it('single direction linkage effect', async () => {
  const form = attach(createForm())
...
it('path change will update computed value', () => {
  const form = attach(createForm())
...
it('field visible default value should work', () => {
  const form = attach(
    createForm({
      effects(form) {
...
it('query value with sibling path syntax', () => {
  const form = attach(createForm())
  const fn = vi.fn()
  attach(
    form.createVoidField({
...
it('relative query with void field', () => {
  const form = attach(createForm())
  attach(
    form.createVoidField({
      name: 'void',
...
it('empty string or number or null value need rewrite default value', () => {
  const form = attach(
    createForm<any>({
      values: {
        aa: '',
...
it('destroy field need auto remove initialValues', () => {
...
it('reactions should not be triggered when field destroyed', () => {
  const form = attach(createForm<any>())
  const handler = vi.fn()
...
it('parent readPretty will overwrite self disabled or readOnly', () => {
  const form = attach(
    createForm<any>({
      readPretty: true,
    }),
...
it('conflict name for errors filter', async () => {
  const form = attach(createForm<any>())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('field destroyed can not be assign value', () => {
  const form = attach(createForm<any>())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('onInput could pass value with target', async () => {
  const form = attach(createForm<any>())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('field destroyed or display none should not be assign value from patch initialValues', () => {
  const form = attach(createForm())
  const aa = attach(
    form.createField({
      name: 'aa',
...
it('onFieldReact with field destroyed', () => {
  const fn = vi.fn()
...
it('field destructor path with display none', () => {
  const form = attach(createForm())
  const aa = attach(
    form.createArrayField({
      name: '[aa,bb]',
...
it('onInput should ignore HTMLInputEvent propagation', async () => {
  const form = attach(createForm<any>())
...
it('onFocus and onBlur with invalid target value', async () => {
  const form = attach(createForm<any>())
  const field = attach(
    form.createField({
      name: 'aa',
...
it('validatePattern and validateDisplay', async () => {
  const form = attach(
    createForm<any>({
