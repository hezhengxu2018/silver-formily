import type { IFieldFactoryProps } from '@silver-formily/core'
import type {
  ISchema,
...
import { each, instOf, isFn, isStr, map } from '@silver-formily/shared'
...
> implements ISchema {
  ...
  setAdditionalProperties = (
    ...
    if (!properties)
      return
    this.additionalProperties = new Schema(properties, this)
