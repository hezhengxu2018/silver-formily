...
it('observable __proto__', () => {
  const observableArr = observable([] as any[])
  Object.setPrototypeOf(observableArr, Object.create(Array.prototype))
  observableArr[0] = {}
  expect(observableArr).toEqual([{}])

  const observableObj = observable({} as any)
  Object.setPrototypeOf(observableObj, Object.create(Object.prototype))
  observableObj.aa = {}
