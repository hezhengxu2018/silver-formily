import type { Dispose, IReactionOptions, Reaction } from './types'
...
export function reaction<T>(tracker: () => T, subscriber?: (value: T, oldValue: T) => void, options?: IReactionOptions<T>) {
  const realOptions = {
    name: 'Reaction',
    ...options,
  }
